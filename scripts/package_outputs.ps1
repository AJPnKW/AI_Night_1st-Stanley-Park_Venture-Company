...
Compress-Archive -Path (Join-Path $projectRoot "docs"), (Join-Path $projectRoot "reports"), (Join-Path $projectRoot "AI_Workshop_4_ventures\web"), (Join-Path $projectRoot "github") -DestinationPath $zipPath -Force
