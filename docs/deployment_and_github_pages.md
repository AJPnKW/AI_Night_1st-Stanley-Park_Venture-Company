...
- publish from the `github/` folder content
- if publishing from repository root, configure Pages to use `/github` content via the selected workflow or copy strategy
