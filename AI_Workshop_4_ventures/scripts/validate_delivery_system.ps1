...
$requiredDocs = @(
  ...
  "docs\participant_workbook_gap_assessment.html",
  "docs\participant_workbook_form_blueprint.html",
  "docs\participant_workbook_sheet_schema.html",
  "docs\participant_workbook_apps_script_spec.html",
...
$contentChecks = @(
  ...
  @{ path = "docs\participant_workbook_gap_assessment.html"; pattern = "Current state versus desired state"; message = "Workbook gap assessment is missing the current-vs-desired-state analysis." },
  @{ path = "docs\participant_workbook_form_blueprint.html"; pattern = "Branching design"; message = "Workbook form blueprint is missing the branching design section." },
  @{ path = "docs\participant_workbook_sheet_schema.html"; pattern = "Suggested tabs"; message = "Workbook sheet schema is missing the suggested tabs section." },
  @{ path = "docs\participant_workbook_apps_script_spec.html"; pattern = "Suggested script functions"; message = "Workbook Apps Script spec is missing the script-functions section." },
