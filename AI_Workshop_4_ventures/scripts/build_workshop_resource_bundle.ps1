...
$pathsToBundle = @(
  ...
  (Join-Path $referenceRoot 'workshop_asset_crosswalk.md'),
  (Join-Path $referenceRoot 'local_source_inventory.md'),
  (Join-Path $referenceRoot 'workshop_resource_expansion_audit.md'),
  (Join-Path $referenceRoot 'duplication_consolidation_review.md'),
